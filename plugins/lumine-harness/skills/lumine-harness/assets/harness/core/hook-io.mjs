...
// Source: skills/lumine-harness/src/harness/core/hook-io.ts
import { stdin, stdout } from "node:process";

//#region skills/lumine-harness/src/harness/core/hook-io.ts
...
function normalizeHookInput(product, event, input = {}) {
	...
	const responseId = firstIdentifier(input, [
	...
	const userTurnId = firstIdentifier(input, [
		"user_turn_id",
		"userTurnId",
		"user_prompt_id",
		"userPromptId"
...
//#endregion
export { normalizeHookInput, readHookInput, writeHookOutput };