...
// Source: skills/lumine-harness/src/harness/adapters/deepseek-harness/hooks/dispatch.ts
...
async function handleDeepSeekHarnessHook(raw = {}) {
	...
	if (event === "session_start") {
		return {
			exitCode: 0,
			stdout: buildSessionStartContext({
				...input,
				root
			})
		};
...
//#endregion
export { handleDeepSeekHarnessHook };